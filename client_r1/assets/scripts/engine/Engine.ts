...
import { Node as ccNode, find as ccFind, game as ccGame} from 'cc';

export default class Engine {
    static engine_init_flag = false;
    static root_node: ccNode;
    ...
    static Init(): void {
        ...
        // 添加常驻根节点
        Engine.root_node = ccFind("Engine");
        if(!Engine.root_node)
        {
            Engine.root_node = new ccNode();
            Engine.root_node.name = "Engine";
        }
        ccGame.addPersistRootNode(Engine.root_node);
